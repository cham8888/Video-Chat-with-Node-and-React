...
class ChatApp extends React.Component {
  ...
  show_reconnect_modal = () => {
    ...
    setTimeout( () => {
      var is_first_user_token = localStorage.getItem("token");
      console.log({is_first_user_token})
      if( (this.attempt_interval !== undefined || this.attempt_interval !== 0) && is_first_user_token){
      // if( (this.attempt_interval !== undefined || this.attempt_interval !== 0)){
